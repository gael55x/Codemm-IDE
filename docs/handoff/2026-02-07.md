...
### Iteration 12 (Docs: Threads Table Note)

- Updated `docs/architecture/IDE_FIRST.md` to reflect that the engine now uses `threads*` tables (and migrates legacy `sessions*` workspaces automatically).
